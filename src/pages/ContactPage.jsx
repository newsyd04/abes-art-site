...
export default function ContactPage() {
  return (
    <div className="min-h-screen font-quicksand bg-gradient-to-tr from-[#D0CABA] to-[#D3C6B6] py-48 px-6 flex items-center justify-center">
      <div className="max-w-xl bg-white rounded-3xl shadow-2xl p-10 text-center">
        ...
        <p className="text-lg font-bold text-gray-700 mt-2 mb-8">
          Reach out to me for inquiries about art lessons, collaborations, or artwork sales. I'd love to hear from you!
        </p>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-center space-x-4">
            ...
            <p className="text-xl font-semibold text-gray-800">abe@artstudio.com</p>
          </div>

          <div className="flex items-center justify-center space-x-4">
            <i className="fa-solid fa-map-marker-alt text-2xl text-[#B2BAC4]"></i>
            <p className="text-xl font-semibold text-gray-800">Annascaul, Co. Kerry</p>
          </div>
        </div>
